...
share-title: Тайны горных имен Кубани
share-description: "Горы говорят: история в названиях. Раскройте тайны происхождения оронимов и узнайте больше о природе и истории Кавказа."
language: ru
...
head-extra: [amp_link.html, etc/_aboutme.html, ads/ads.html, etc/micro/faq/subpages/mountains.html]
