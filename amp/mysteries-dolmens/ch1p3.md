...
cover-img: ["/img/mysteries-dolmens/1-3/cover.jpg" : "Пласты осадочных горных пород, примерно из таких обнажений отбирались  заготовки (блоки, плиты) необходимые для сооружения дольменов"]
